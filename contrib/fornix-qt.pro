...
RESOURCES += src/qt/fornix.qrc src/qt/fornix_locale.qrc

TRANSLATIONS += src/qt/locale/fornix_bg.ts \
                src/qt/locale/fornix_de.ts \
                src/qt/locale/fornix_en.ts \
                src/qt/locale/fornix_es.ts \
                src/qt/locale/fornix_fi.ts \
                src/qt/locale/fornix_fr.ts \
                src/qt/locale/fornix_it.ts \
                src/qt/locale/fornix_ja.ts \
                src/qt/locale/fornix_pl.ts \
                src/qt/locale/fornix_pt.ts \
                src/qt/locale/fornix_ru.ts \
                src/qt/locale/fornix_sk.ts \
                src/qt/locale/fornix_sv.ts \
                src/qt/locale/fornix_vi.ts \
                src/qt/locale/fornix_zh_CN.ts \
                src/qt/locale/fornix_zh_TW.ts
