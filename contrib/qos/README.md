...
This means one can have an always-on fornixd instance running, and another local fornixd/fornix-qt instance which connects to this node and receives blocks from it.
