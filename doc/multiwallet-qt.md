...
In order to support loading of multiple wallets in fornix-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is fornix.cpp.
...
Changes to fornix.cpp
----------------------
fornix.cpp is the entry point into fornix-qt, and as such, will require some minor modifications to provide hooks for
