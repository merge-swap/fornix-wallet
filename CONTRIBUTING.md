...
The Fornix project operates an open contributor model where anyone is
...
The following applies to code changes to the Fornix project, and is not to be
confused with overall FORNIX Network Protocol consensus changes.

Whether a pull request is merged into Fornix rests with the project merge
...
Patches that change FORNIX consensus rules are considerably more involved than
...
Where a patch set proposes to change the FORNIX consensus, it must have been
...
The project leader is the release manager for each Fornix release.
