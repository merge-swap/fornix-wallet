...
/** Utility functions used by the FORNIX Qt UI.
 */
namespace GUIUtil
{
...
// Render FORNIX addresses in monospace font
...
// Parse "fornix:" URI into recipient object, return true on successful parsing
