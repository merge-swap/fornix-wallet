...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a FORNIX address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and fornix: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Fornix"), this);
    aboutAction->setStatusTip(tr("Show information about Fornix"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for FORNIX"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your FORNIX addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified FORNIX addresses"));
    ...
    openAction->setStatusTip(tr("Open a FORNIX: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Fornix help message to get a list with possible FORNIX command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Fornix client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to FORNIX network", "", count));
}
...
{
    QString strTitle = tr("Fornix"); // default title
