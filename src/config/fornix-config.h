/* src/config/fornix-config.h.  Generated from fornix-config.h.in by configure.  */
/* src/config/fornix-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef Fornix_CONFIG_H

#define Fornix_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.fornix.co"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Fornix Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Fornix Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "fornix"
