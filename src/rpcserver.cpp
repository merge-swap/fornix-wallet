...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Fornix features */
        {"fornix", "masternode", &masternode, true, true, false},
        {"fornix", "listmasternodes", &listmasternodes, true, true, false},
        {"fornix", "getmasternodecount", &getmasternodecount, true, true, false},
        {"fornix", "masternodeconnect", &masternodeconnect, true, true, false},
        {"fornix", "masternodecurrent", &masternodecurrent, true, true, false},
        {"fornix", "masternodedebug", &masternodedebug, true, true, false},
        {"fornix", "startmasternode", &startmasternode, true, true, false},
        {"fornix", "createmasternodekey", &createmasternodekey, true, true, false},
        {"fornix", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"fornix", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"fornix", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"fornix", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"fornix", "getmasternodescores", &getmasternodescores, true, true, false},
        {"fornix", "mnbudget", &mnbudget, true, true, false},
        {"fornix", "preparebudget", &preparebudget, true, true, false},
        {"fornix", "submitbudget", &submitbudget, true, true, false},
        {"fornix", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"fornix", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"fornix", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"fornix", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"fornix", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"fornix", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"fornix", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"fornix", "checkbudgets", &checkbudgets, true, true, false},
        {"fornix", "mnsync", &mnsync, true, true, false},
        {"fornix", "spork", &spork, true, true, false},
        {"fornix", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"fornix", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use fornixd, or the -server option to fornix-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> fornix-cli " + methodname + " " + args + "\n";
}
